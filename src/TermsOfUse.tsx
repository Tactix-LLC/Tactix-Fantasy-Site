        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl p-8 md:p-12">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-8">
              By downloading, installing, accessing, or using the Tactix Fantasy Football Manager application ("the App"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, do not use the App. The App is provided by Tactix LLC. These Terms constitute a legally binding agreement between you and Tactix LLC.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-6">
              We may terminate or suspend your access to the App immediately, without prior notice, for any breach of these Terms. Upon termination, your right to use the App will cease immediately, and we may delete your account and associated data.
            </p>
